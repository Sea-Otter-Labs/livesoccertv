from sqlalchemy import Column, BigInteger, Integer, String, Date, JSON, Numeric, ForeignKey, Index, DateTime
...
class MatchBroadcast(BaseModel):
    ...
    def __repr__(self):
        return f"<MatchBroadcast(fixture_id={self.fixture_id}, {self.home_team_name} vs {self.away_team_name}, status={self.broadcast_match_status})>"
